...
class lateset_tweets extends WP_Widget {
	function __construct() {
		...
		$widget_ops = array('classname' => 'tweets','description' => esc_attr__('Twitter Widget - displays Latest Tweets','viennatheme'));
/*		$control_ops = array( 'twitter name' => 'pulsar', 'count' => 3, 'avatar_size' => '32' );
*/		
		parent::__construct('latest-tweets',esc_attr__('[Micro Themes] - Twitter','viennatheme'),$widget_ops);
...
<?php 
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => esc_attr__('Twitter','viennatheme'), 
			'twitterWidgetID' => '', 
			'count' => 3,
			'enableLinks' => 0,
			'showUser' => 0,
    	...
    	<p>
		<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_attr_e('Title:', 'viennatheme') ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id( 'twitterWidgetID' ); ?>"><?php esc_attr_e('Twitter Widget ID:', 'viennatheme'); ?> <a href="https://www.pulsarmedia.ca/generating-a-twitter-widget-id/" target="_blank"><?php esc_attr_e('More info', 'viennatheme'); ?></a></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id( 'count' ); ?>"><?php esc_attr_e('Number of tweets to display:', 'viennatheme') ?></label>
        ...
        <p>  
            ...
            <label for="<?php echo $this->get_field_id( 'enableLinks' ); ?>"><?php esc_attr_e('Activate Links?', 'viennatheme'); ?></label>  
        </p>
        ...
        <p>  
            ...
            <label for="<?php echo $this->get_field_id( 'showUser' ); ?>"><?php esc_attr_e('Display User Thumbnail?', 'viennatheme'); ?></label>  
        </p>
        ...
        <p>  
            ...
            <label for="<?php echo $this->get_field_id( 'showTime' ); ?>"><?php esc_attr_e('Display time of tweet?', 'viennatheme'); ?></label>  
        </p>
        ...
        <p>  
            ...
            <label for="<?php echo $this->get_field_id( 'showInteraction' ); ?>"><?php esc_attr_e('Display Interaction Links?', 'viennatheme'); ?></label>  
        </p>
