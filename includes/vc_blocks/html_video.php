...
vc_map( array(
    ...
    "name"      => __("HTML5 Video", 'medicallinktheme'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            "type" => "textfield",
            "heading" => __("WebM video", 'medicallinktheme'),
            "param_name" => "el_webm",
            "description" => __("Enter the URL path to your WebM formatted video.", 'medicallinktheme'),
			"value" => ''
        ),
		
		array(
            "type" => "textfield",
            "heading" => __("MP4 video", 'medicallinktheme'),
            "param_name" => "el_mp4",
            "description" => __("Enter the URL path to your MP4 formatted video.", 'medicallinktheme'),
			"value" => ''
        ),
		
		array(
            "type" => "textfield",
            "heading" => __("OGG video", 'medicallinktheme'),
            "param_name" => "el_ogg",
            "description" => __("Enter the URL path to your OGG formatted video.", 'medicallinktheme'),
			"value" => ''
        ),
		...
		array(
            ...
            "param_name" => "content",
            "description" => __("Enter content if required.", 'medicallinktheme'),
			"value" => ''
        ),
