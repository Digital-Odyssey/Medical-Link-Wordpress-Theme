...
class WPBakeryShortCode_pm_ln_recent_properties extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        <?php if ($query->have_posts()) : while ($query->have_posts()) : $query->the_post(); ?>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 pm-column-spacing pm-recent-property-shortcode-post">
                ...
                <div class="pm-property-listings-info-container related">
                    ...
                    <a href="'.get_the_permalink().'" class="pm-property-listing-title"><?php the_title() ?></a>
                    ...
                    <ul class="pm-property-listings-info-list">
                        ...
                        <?php } else { ?>                            
                            ...
                            <?php if( is_user_logged_in() ){ ?>
                                ...
                                <?php if( $formattedPrice !== 0 ){ ?>
                                    <li><?php echo esc_attr($currencySymbol) . esc_attr($formattedPrice) .' '. ($pm_properties_rental_type_meta === 'default' ? '' : '/'. $pm_properties_rental_type_meta.'') ?></li>
                                <?php } ?>
        ...
        <?php endwhile; else: ?>
        	...
        	<p><?php esc_html__('No recent properties were found.', 'medicallinktheme') ?></p>
...
vc_map( array(
    ...
    "name"      => __("Recent Properties", 'medicallinktheme'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            "type" => "textfield",
            "heading" => __("Number of Properties to display", 'medicallinktheme'),
            "param_name" => "num_of_posts",
            "description" => __("Enter a positive integer.", 'medicallinktheme')
        ),
