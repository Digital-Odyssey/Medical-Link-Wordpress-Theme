...
class WPBakeryShortCode_pm_ln_agent_profile extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        <div class="pm-staff-profile-container <?php esc_attr_e($el_class); ?>" data-wow-duration="1s" data-wow-offset="50" data-wow-delay="0.3s">
            ...
            <p class="pm-staff-profile-name"><?php esc_attr_e($postTitle); ?></p>
...
vc_map( array(
    ...
    "name"      => __("Agent Profile", 'medicallinktheme'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            "type" => "textfield",
            "heading" => __("Agent Post ID", 'medicallinktheme'),
            "param_name" => "el_id",
            "description" => __("Enter the post ID assigned to your Agent profile.", 'medicallinktheme')
        ),
