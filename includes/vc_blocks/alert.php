    ...
    protected function content($atts, $content = null) {
        ...
        <div class="alert alert-dismissible" role="alert" style="background-color:<?php esc_attr_e($bg_color); ?>;">
          ...
          <?php if($close == 'true') { ?>
             ...
             <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only"><?php esc_html_e('Close', 'medicallinktheme') ?></span></button>
...
vc_map( array(
    ...
    "base"      => "pm_ln_alert",
    "name"      => __("Alert Message", 'medicallinktheme'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            ...
            "param_name" => "bg_color",
            //"description" => __("Enter a typicon icon value.", 'medicallinktheme'),
			"value" => '#2C5E83',
        ),
			
		array(
            "type" => "dropdown",
            "heading" => __("Display close button?", 'medicallinktheme'),
            "param_name" => "close",
		...
		/*array(
            "type" => "dropdown",
            "heading" => __("Alert type", 'medicallinktheme'),
            "param_name" => "alert",
            "description" => __("Select your desired alert type.", 'medicallinktheme'),
