...
vc_map( array(
    ...
    "name"      => __("Countdown", 'medicallinktheme'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            ...
            "param_name" => "el_id",
            "description" => __("Assign a unique numeric ID value to prevent conflicts with multiple countdowns on a single page.", 'medicallinktheme'),
		...
		array(
            ...
            "param_name" => "el_date",
            "description" => __("Enter a date in the following format: 2016/08/25", 'medicallinktheme'),
			"value" => '2017/08/25'
        ),
		...
		array(
            ...
            "description" => __("Accepts a positive integer for the font size.", 'medicallinktheme'),
			"value" => '24'
        ),
				
		array(
            "type" => "dropdown",
            "heading" => __("Text Alignment", 'medicallinktheme'),
            "param_name" => "el_text_align",
            "description" => __("Set the alignment of the text.", 'medicallinktheme'),
