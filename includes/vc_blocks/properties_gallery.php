    ...
    protected function content($atts, $content = null) {
        ...
        <div class="pm-image-gallery" id="pm-image-gallery">
            ...
            <div class="image-gallery-inner">
                        ...
                        <?php } else { ?>
                            ...
                            <?php if( is_user_logged_in() ){ ?>
                                ...
                                <?php if( $formattedPrice !== 0 ) { ?>
                                    ...
                                    <a class="pm-image-gallery-item-hover-btn" href="#" data-index="<?php echo $dataIndex ?>" data-big-image="<?php esc_html_e($pm_properties_image_meta); ?>" data-post-url="<?php the_permalink(); ?>" data-post-title="<?php echo $title; ?>" data-sale-price="&bull; <?php echo $currencySymbol . esc_attr($formattedPrice) . ($pm_properties_rental_type_meta === 'default' ? '' : '/'.$pm_properties_rental_type_meta.''); ?>" data-sale-status="<?php esc_attr_e($pm_properties_status_meta); ?>" data-gmap-latitude="<?php esc_attr_e($pm_properties_address_lat_meta); ?>" data-gmap-longitude="<?php esc_attr($pm_properties_address_long_meta); ?>" data-address="<?php esc_attr_e($pm_properties_address_meta).' '.esc_attr($pm_properties_city_meta).', '.esc_attr($pm_properties_state_meta).' '.esc_attr($pm_properties_country_meta).' '.esc_attr($pm_properties_zip_meta); ?>" data-column="<?php echo $dataColumn; ?>"></a>
                ...
                <?php endwhile; else: ?>
                     <p><?php esc_html_e('No featured properties were found.', 'medicallinktheme'); ?></p>
                <?php endif; ?>
            ...
            <div class="pm-image-gallery-lightbox" id="pm-image-gallery-lightbox">
                ...
                <div class="pm-image-gallery-lightbox-info-container">
                    <ul class="pm-image-gallery-lightbox-info-list">
                        ...
                        <li id="sale_price"></li>
                        <li><a href="#" id="lightbox_map_btn"><?php esc_html_e('View Map','medicallinktheme'); ?></a></li>
                    </ul>
                </div>
                <div class="inner"></div>
...
vc_map( array(
    ...
    "name"      => __("Properties Gallery", 'medicallinktheme'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            ...
            "description" => __("Set the order in which the property posts are displayed.", 'medicallinktheme'),
