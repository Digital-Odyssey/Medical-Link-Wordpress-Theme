		...
		if(is_array($slides)) :
            ...
            if(count($slides) > 0){
                ...
                echo '<div class="pm-pulse-container" id="pm-pulse-container">';
                    ...
                    echo '<div id="pm-pulse-loader"><img src="'.get_template_directory_uri().'/js/pulse/img/ajax-loader.gif" alt="'.esc_html__('slider loading', 'medicallinktheme').'" /></div>';
                                ...
                                echo '<li data-thumb="'.$s['image'].'" class="pmslide_'.$sliderCounter.'"><img src="'.$s['image'].'" alt="Slider image '.$sliderCounter.'" />';
                                    ...
                                    echo '<div class="pm-holder'. ($enableFixedHeight === 'false' ? ' scalable' : '') .'">';
                                        echo '<div class="pm-caption'. ($enableFixedHeight === 'false' ? ' scalable' : '') .'">';
                                              ...
                                              if( !empty($s['title']) ) :
                                                  echo '<h1>'.esc_html__($title, 'medicallinktheme').'</h1>';
                                              endif;
                                              
                                              if( !empty($s['title']) ) :
                                              
                                                  echo '<span class="pm-caption-decription'. ($enableFixedHeight === 'false' ? ' scalable' : '') .'">';
                                                    echo esc_html__($subTitle, 'medicallinktheme');
                                                  echo '</span>';
                                              ...
                                              if( !empty($s['description']) ) :
                                                  ...
                                                  echo '<span class="pm-caption-excerpt'. ($enableFixedHeight === 'false' ? ' scalable' : '') .'">';
                                                    echo esc_html__($s['description'], 'medicallinktheme');
                                                  echo '</span>';
                                              ...
                                              if( !empty($s['description']) ) :
                                                  ...
                                                  echo '<a href="'.$btnUrl.'" class="pm-slide-btn'. ($enableFixedHeight === 'false' ? ' scalable' : '') .'">'.esc_html__($btnText, 'medicallinktheme').' <i class="fa fa-plus"></i></a>';
...
vc_map( array(
    ...
    "name"      => __("Micro Slider", 'medicallinktheme'),
    "class"     => "",
