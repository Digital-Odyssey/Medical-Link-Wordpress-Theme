...
vc_map( array(
    ...
    "base"      => "pm_ln_videobox",
    "name"      => __("Video Box", 'medicallinktheme'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            ...
            "param_name" => "el_icon",
            "description" => __("Enter a FontAwesome 4 or Typicon icon value.", 'medicallinktheme'),
			"value" => 'typcn typcn-video'
        ),
		
		array(
            "type" => "textfield",
            "heading" => __("Video URL", 'medicallinktheme'),
            "param_name" => "el_video_link",
            "description" => __("Enter a URL path for your video. (Ex. https://www.youtube.com/watch?v=XFPLSUZBCB8)", 'medicallinktheme'),
			"value" => ''
        ),
		...
		array(
            ...
            "description" => __("Upload a background image for your video box.", 'medicallinktheme')
        ),
		
		array(
            "type" => "dropdown",
            "heading" => __("Activate Video Link?", 'medicallinktheme'),
            "param_name" => "el_link",
            "description" => __("Choose whether to activate the video link.", 'medicallinktheme'),
			"value"      => array( 'on' => 'on', 'off' => 'off' ), //Add default value in $atts
        ),
		
		array(
            "type" => "textfield",
            "heading" => __("Video Link Text", 'medicallinktheme'),
            "param_name" => "el_link_text",
            "description" => __("Enter a custom message for your video link button - only applies if Video link is active.", 'medicallinktheme'),
			"value" => 'View our gallery'
        ),
		
		array(
            "type" => "textfield",
            "heading" => __("Video Link URL", 'medicallinktheme'),
            "param_name" => "el_link_url",
            "description" => __("Enter a custom URL for your video link button - only applies if Video link is active.", 'medicallinktheme'),
			"value" => ''
        ),
