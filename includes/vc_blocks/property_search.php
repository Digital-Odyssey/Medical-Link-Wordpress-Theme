    ...
    protected function content($atts, $content = null) {
        ...
        <div class="pm-property-search-column <?php esc_attr_e($el_class); ?>">
                    ...
                    <div class="col-lg-12 pm-center">
                        ...
                        <form id="pm-property-search-module" action="<?php echo site_url(''.$el_results_page.''); ?>" method="get">
                            <ul class="pm-property-search-system">
                                <li><input type="text" name="city" placeholder="<?php  esc_html_e('City', 'medicallinktheme'); ?>" class="pm-property-search-text-field" id="search_city"></li>
                                <li>
                                    <div class="pm-dropdown pm-filter-system category">
                                        <div class="pm-dropmenu">
                                            <p class="pm-menu-title"><?php esc_html_e('Property Type','medicallinktheme'); ?></p>
                                ...
                                <li>
                                    <div class="pm-dropdown pm-filter-system type">
                                        <div class="pm-dropmenu">
                                            <p class="pm-menu-title"><?php esc_html_e('Sale Type','medicallinktheme'); ?></p>
                                            <i class="fa fa-angle-down"></i>
                                        </div>
                                ...
                                <li><input type="text" name="min_price" placeholder="<?php esc_html_e('Min. Price','medicallinktheme'); ?>" class="pm-property-search-text-field"></li>
                                <li><input type="text" name="max_price" placeholder="<?php esc_html_e('Max. Price','medicallinktheme'); ?>" class="pm-property-search-text-field"></li>
                            </ul>
            ...
            <div class="pm-property-search-btn-container">
                ...
                <a href="#" class="pm-property-search-btn-link"><?php esc_html_e('Search','medicallinktheme'); ?></a>
            </div>
...
vc_map( array(
    ...
    "name"      => __("Property Search", 'medicallinktheme'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            ...
            "param_name" => "el_title",
            "description" => __("Enter a title if required", 'medicallinktheme'),
			"value"      => '', //Add default value in $atts
        ),
		
		array(
            "type" => "textfield",
            "heading" => __("Results Page", 'medicallinktheme'),
            "param_name" => "el_results_page",
            "description" => __("Enter the URL slug for the property search results template page.", 'medicallinktheme'),
		...
		array(
            ...
            "param_name" => "content",
            "description" => __("Enter a message if required.", 'medicallinktheme'),
			"value"      => '', //Add default value in $atts
        ),
		...
		array(
            ...
            "param_name" => "el_class",
            "description" => __("Apply a CSS class to the parent container if required.", 'medicallinktheme')
        ),
