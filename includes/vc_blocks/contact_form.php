        ...
        <div class="pm-contact-form-container">
			...
			<form action="#" method="post" id="pm-contact-form">
				...
				<div class="col-lg-6 col-md-6 col-sm-12">
					<input name="pm_s_first_name" id="pm_s_first_name" class="pm-form-textfield" type="text" placeholder="<?php esc_attr_e('First Name *', 'medicallinktheme'); ?>">
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12">
					<input name="pm_s_last_name" id="pm_s_last_name" class="pm-form-textfield" type="text" placeholder="<?php esc_attr_e('Last Name *', 'medicallinktheme'); ?>">
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12">
					<input name="pm_s_email_address" id="pm_s_email_address" class="pm-form-textfield" type="text" placeholder="<?php esc_attr_e('Email Address *', 'medicallinktheme'); ?>">
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12">
					<input name="pm_s_phone_number" id="pm_s_phone_number" class="pm-form-textfield" type="tel" placeholder="<?php esc_attr_e('Phone Number', 'medicallinktheme'); ?>">
				</div>
				<div class="col-lg-12 pm-clear-element">
					<textarea name="pm_s_message" id="pm_s_message" class="pm-form-textarea" cols="50" rows="10" placeholder="<?php esc_attr_e('Message *', 'medicallinktheme'); ?>"></textarea>
				</div>
				...
				<div class="col-lg-12 pm-center" style="margin-top:20px">
					<input type="button" value="<?php esc_attr_e('Submit Form', 'medicallinktheme'); ?>" name="pm-form-submit-btn" class="pm-form-submit-btn" id="pm-contact-form-btn">
...
vc_map( array(
    ...
    "name"      => __("Contact Form", 'medicallinktheme'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            "type" => "textfield",
            "heading" => __("Recipient email address", 'medicallinktheme'),
            "param_name" => "recipient_email",
            "description" => __("Enter the email address where the message will be sent to.", 'medicallinktheme'),
			"value" => 'info@microthemes.ca'
        ),
		
		array(
            "type" => "textfield",
            "heading" => __("Form Message", 'medicallinktheme'),
            "param_name" => "message",
		...
		array(
            "type" => "colorpicker",
            "heading" => __("Response Color", 'medicallinktheme'),
