...
vc_map( array(
    "name" => __("Tab Menu", 'medicallinktheme'),
    ...
    "params" => array(
       ...
       array(
            ...
            "param_name" => "el_id",
            "description" => __("Assign a unique number value for this Tab Group. If you are creating multiple Tab Groups on a single page please make sure each Tab Group has a unique number assigned to it in order to avoid conflicts between menus.", 'medicallinktheme'),
...
vc_map( array(
    "name" => __("Tab Menu Item", 'medicallinktheme'),
