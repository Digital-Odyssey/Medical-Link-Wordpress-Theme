...
class fb_likebox_widget extends WP_Widget {
	function __construct() {
		...
		$widget_ops = array('classname' => 'Like-box','description' => esc_html__('Facebook Like Box','medicallinktheme'));

		parent::__construct('Like-box',esc_html__('[Micro Themes] - Facebook Likebox','medicallinktheme'),$widget_ops);
...
function form( $instance ) {
		...
		$defaults = array(
			'title' => esc_html__('Facebook','medicallinktheme'),
			//'fa_icon' => '',
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e('Title:', 'medicallinktheme') ?></label>
		...
		<p>  
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'minimize_header' )); ?>"><?php esc_html_e('Minimize header?', 'medicallinktheme'); ?></label>  
        </p>  
        ...
        <p>  
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'show_faces' )); ?>"><?php esc_html_e('Display faces?', 'medicallinktheme'); ?></label>  
        </p> 
        ...
        <p>  
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'show_cover' )); ?>"><?php esc_html_e('Display cover?', 'medicallinktheme'); ?></label>  
        </p> 
        ...
        <p>  
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'show_stream' )); ?>"><?php esc_html_e('Display stream?', 'medicallinktheme'); ?></label>  
        </p>  

    	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'height' )); ?>"><?php esc_html_e('Height:', 'medicallinktheme') ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'page' )); ?>"><?php esc_html_e('Facebook Page URL:', 'medicallinktheme') ?></label>
