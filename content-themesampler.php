...
<div id="pm_theme_color_selector">
    ...
    <p class="pm_theme_color_selector_title"><?php esc_attr_e('Style Sampler','medicallinktheme'); ?></p>

    <div class="pm_theme_color_selector_container">
        <p><?php esc_attr_e('Layout Style','medicallinktheme'); ?></p>
        <select name="pm_theme_color_selector_mode" id="pm_theme_color_selector_mode">
          <option value="pm-full-mode" selected><?php esc_attr_e('Fullscreen','medicallinktheme'); ?></option>
          <option value="pm-boxed-mode"><?php esc_attr_e('Boxed Mode','medicallinktheme'); ?></option>
        </select>
    </div>
    <div class="pm_theme_color_selector_container">
        <p><?php esc_attr_e('Patterns for Boxed Mode','medicallinktheme'); ?></p>
        <ul class="pm_theme_img_selector" id="pm_theme_pattern_selector">
            <li><a href="#" id="pattern1-lg"><img src="<?php echo get_template_directory_uri(); ?>/img/boxed-patterns/pattern1.png" alt="pattern1"></a></li>
            <li><a href="#" id="pattern2-lg"><img src="<?php echo get_template_directory_uri(); ?>/img/boxed-patterns/pattern2.png" alt="pattern2"></a></li>
            <li><a href="#" id="pattern3-lg"><img src="<?php echo get_template_directory_uri(); ?>/img/boxed-patterns/pattern3.png" alt="pattern3"></a></li>
    ...
    <div class="pm_theme_color_selector_container">
        <p><?php esc_attr_e('Backgrounds for Boxed Mode','medicallinktheme'); ?></p>
